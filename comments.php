...
<?php if ( have_comments() ) : ?>
	<h3 id="comments"><?php comments_number('Fara comentarii', 'Un comentariu', '% comentarii' );?> pentru &#8220;<?php the_title(); ?>&#8221;</h3>
...
<h3><?php comment_form_title( 'Comentarii', 'Asteptam parerea Dvs. la articolul %s' ); ?></h3>
...
<br/>
<label for="email"><small>Email (confidential) <?php if ($req) echo "(obligatoriu)"; ?></small></label></p>
