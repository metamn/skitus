	...
	<div id="blog" class="block" role="main">
	  <div id="inside" class="opacity-7">	    
     	  ...
     	  <?php /* If this is a category archive */ if (is_category()) { ?>
		    <h2 class="pagetitle">Arhiva pentru categoria &#8216;<?php single_cat_title(); ?>&#8217;</h2>
     	  <?php /* If this is a tag archive */ } elseif( is_tag() ) { ?>
		    <h2 class="pagetitle">Arhiva etichete &#8216;<?php single_tag_title(); ?>&#8217;</h2>
     	  <?php /* If this is a daily archive */ } elseif (is_day()) { ?>
		    <h2 class="pagetitle">Arhiva <?php the_time('d/M/Y'); ?></h2>
     	  <?php /* If this is a monthly archive */ } elseif (is_month()) { ?>
		    <h2 class="pagetitle">Arhiva <?php the_time('M Y'); ?></h2>
     	  <?php /* If this is a yearly archive */ } elseif (is_year()) { ?>
		    <h2 class="pagetitle">Arhiva <?php the_time('Y'); ?></h2>
	      <?php /* If this is an author archive */ } elseif (is_author()) { ?>
		    <h2 class="pagetitle">Arhivele autorului</h2>
